...
(function (factory) {
  ...
  $.extend($.summernote.lang, {
    'en-US': {
      ...
      image: {
        image: 'Picture',
        insert: 'Image Manager By SIAM GO LIVE',
  ...
  var ImageDialog = function (context) {
    ...
    this.initialize = function () {
      ...
      var bodyx = '<div class="form-group note-group-select-from-files">' +
                 ...
                 '</div>';
      var footerx = '<button href="#" class="btn btn-primary note-image-btn disabled" disabled>' + lang.image.insert + '</button>';
      var body = '';
      var footer = false;
    ...
    this.showImageDialog = function () {
      return $.Deferred(function (deferred) {
        ...
        ui.onDialogShown(self.$dialog, function () {
          context.triggerEvent('dialog.shown');
          var newhtml = '<div class="col-xs-12" style="text-align:center;"><img src="'+BASEURL+'/assets/images/319.gif"/></div>';
          		newhtml += '<div class="clearfix"></div>';
          $('.modal-body','.image-dialog').html(newhtml);
          $('.modal-dialog','.image-dialog').addClass('modal-lg');
          $.ajax({ 
			   type: "GET", 
			   url:  BASEURL+"/utility/filemanager/",
			   success: function(resp){
			   		//body = resp;
			   		setTimeout(function(){
			   			$('.modal-body','.image-dialog').html(resp);
			   		},600);
         ...
         /* $('a',this).click(function(event){
          ...
          $("body").delegate('a img','click', function(){
			    var imgsrc = $(this).attr('src');
			    //self.insertImage(imgsrc, 'imgs');
			   // this.insertImages(imgsrc);
